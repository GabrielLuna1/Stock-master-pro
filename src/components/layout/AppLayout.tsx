  ...
  return (
    <div className="h-screen bg-gray-50 flex flex-col lg:flex-row overflow-hidden">
      ...
      <div className="flex-1 flex flex-col h-full min-w-0 bg-gray-50/50">
        {/* HEADER MOBILE (Agora é Sticky/Grudado no topo) */}
        <header className="lg:hidden sticky top-0 z-30 bg-white/80 backdrop-blur-md border-b border-gray-200 px-4 py-3 flex items-center justify-between shadow-sm">
          <div className="flex items-center gap-3">
            {/* Logo Compacto */}
            <div className="bg-brand-red w-8 h-8 rounded-lg flex items-center justify-center shadow-sm shadow-red-200">
          ...
          <button
            ...
            className="p-2 text-gray-600 hover:bg-gray-100 hover:text-brand-red rounded-lg transition-all active:scale-95"
          >
